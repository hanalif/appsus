export default {
    ...
    <router-link  to="/" ><i @click="closeMenue" class="fas menu-icon fa-home"></i></router-link>
    <router-link  to="/keep"><i @click="closeMenue" class="fas menu-icon fa-sticky-note"></i></router-link>
    <router-link  to="/mail"><i @click="closeMenue" class="fas menu-icon fa-envelope"></i></router-link>
    </div>
    <div class="apps-icons">
